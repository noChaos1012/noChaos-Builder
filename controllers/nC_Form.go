...
// @router /create [Post]
func (f *FormController) Create() { f.CreateWithModel(&models.NC_Form{}) }
...
func (f *FormController) GetDetail() { f.GetDetailWithModel(&models.NC_Form{}) }
...
// @Failure 403 body is empty
// @router /update [Post]
func (f *FormController) Update() { f.UpdateWithModel(&models.NC_Form{}) }
...
// @Failure 403 body is empty
// @router /delete [Post]
func (f *FormController) Delete() { f.DeleteWithModel(&models.NC_Form{}) }
