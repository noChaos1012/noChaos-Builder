...
func init() {
    ...
    beego.GlobalControllerRouter["com.waschild/noChaos-Server/controllers:Panduanceshi20041301_27"] = append(beego.GlobalControllerRouter["com.waschild/noChaos-Server/controllers:Panduanceshi20041301_27"],
        beego.ControllerComments{
            Method: "Panduanceshi20041301_27",
            Router: `/Panduanceshi20041301_27`,
            AllowHTTPMethods: []string{"Post"},
            MethodParams: param.Make(),
            Filters: nil,
            Params: nil})
